...
@interface BJSmoothLineView ()
{
    CAShapeLayer *anmitionLayer;//折线
...
@implementation BJSmoothLineView
...
-(void)makeChartXView{
    ...
    layerX.backgroundColor = [UIColor grayColor].CGColor;
...
-(void)makeChartYView{
    ...
    layerY.backgroundColor = [[UIColor grayColor] CGColor];
    ...
    for (int i=0; i<5; i++) {
        if (i!=5) {
            ...
            layer5.backgroundColor = [[UIColor grayColor] CGColor];
...
//    layerLeft.backgroundColor = [[UIColor grayColor] CGColor];
...
-(void)drawSmoothViewWithArrayX:(NSArray*)pathX andArrayY:(NSArray*)pathY andScaleX:(float)X{
    ...
    layer.strokeColor = [UIColor colorWithRed:46/255.0 green:200/255.0 blue:237/255.0 alpha:0.5].CGColor;
